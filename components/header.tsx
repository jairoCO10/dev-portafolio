...
import { Moon, Sun, Terminal, Github, Linkedin, X, FileText} from 'lucide-react';
    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-center">
        ...
        <nav className="flex flex-1 items-center justify-center space-x-6 text-sm">
          <Link href="/projects" className="transition hover:text-foreground/80">Projectos</Link>
        ...
        <nav className="flex flex-1 items-center justify-center space-x-6 text-sm">
          <a
            href="https://github.com/jairoco10"
            target="_blank"
